...
export default {
  ...
  data() {
    return {
      ...
      qty: 1,
      product: {
        name: store.getters.productDetail.title,
        qty:1,
        description:
        ...
        images: [
          {
            mobile: { url: store.getters.productDetail.image },
            desktop: { url: store.getters.productDetail.image },
            big: { url: store.getters.productDetail.image },
            alt: "Product A",
          },
          {
            mobile: { url: store.getters.productDetail.image },
        ...
        price: store.getters.productDetail.price.regular,
        colors: store.getters.productDetail.colors,
        rating: {
          rate: 4,
          max: 5,
        },
